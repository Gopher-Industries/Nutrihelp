...
const HealthConditions2 = () => {
  ...
  return (
    <View style={styles.healthConditions2}>
      <View style={styles.timeConnectionBar}>
        <Text style={styles.time}>9:30</Text>
        <Image
          style={styles.cameraCutoutIcon}
          resizeMode="cover"
          source={require("../assets/camera-cutout7.png")}
        />
        <Image
          style={styles.rightIcons}
          resizeMode="cover"
          source={require("../assets/right-icons7.png")}
        />
      </View>
      ...
      <RNPTextInput
        ...
        mode="outlined"
        left={
          <RNPTextInput.Icon style={{ marginTop: "50%" }} name="mdiMagnify" />
        }
        placeholderTextColor="#79747e"
        theme={{ colors: { text: "#79747e" } }}
      />
      ...
      <TouchableHighlight
        style={styles.hypertensionButton}
...
export default HealthConditions2;
